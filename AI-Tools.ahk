...
deIdentify(medical_history) {
    ; 1. Names
    chinese_surnames := "陳|林|黃|張|李|王|吳|劉|蔡|楊|許|鄭|謝|洪|郭|邱|曾|廖|賴|徐|周|葉|蘇|莊|呂|江|何|蕭|羅|高|潘|簡|朱|鍾|游|彭|詹|施|胡|沈|余|盧|梁|趙|顏|柯|翁|魏|孫|戴|范|方|宋|鄧|杜|侯|傅|曹|薛|阮|丁|卓|馬|温|董|藍|古|石|紀|唐|蔣|姚|連|歐|馮|程|湯|田|康|黄|姜|白|汪|尤|鄒|黎|巫|鐘|涂|龔|嚴|韓|袁|金|童|陸|柳|凃|夏|邵" ; Common Chinese surnames
